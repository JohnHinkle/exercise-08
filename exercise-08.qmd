...
```
## Step 6a: Calculate standard error, p-value, and 95% confidence interval for the slope coefficent
...
## Step 6b: Calculate standard error, p-value, and 95% confidence interval for the slope coefficent
